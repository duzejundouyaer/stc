...
<div class="wpb_wrapper">
    @foreach($details_info as $val)
<div style="text-align: center;"><span style="font-size:22px;"><span style="font-family: 微軟正黑體;"><span style="color: rgb(0, 0, 0);">{{$val->man_name}}</span></span></span></div>
</div>
</div>
...
<div class="wpb_wrapper"><span></span><img width="620" height="413" src="{{$val->man_img}}" class="front_image  attachment-full" alt="7279-1-620x-u" title="" description="" data-title="7279-1-620x-u" src-img="" style=''/></div>
</div>
...
<div class="wpb_wrapper">
    ...
    <div class="post-comment" style="color:#686868;font-size:12px;line-height:12px;">
        <span> <span class="post_date">联系方式：<span data-date="{{$val->man_phone}}" class="post_date_text">{{$val->man_phone}}</span></span> </span>
    </div>
    <div class="post-comment" style="color:#686868;font-size:12px;line-height:12px;">
        <br>
        <span> <span class="post_date">发布时间：<span data-date="{{$val->man_addtime}}" class="post_date_text">{{date("Y-m-d",$val->man_addtime)}}</span></span> </span>
    </div>

    <div class="post-comment" style="color:#686868;font-size:12px;line-height:12px;">
        <br>
        <span> <span class="post_date">网点位置：<span data-date="{{$val->man_address}}" class="post_date_text">{{$val->man_address}}</span></span> </span>
    </div>
