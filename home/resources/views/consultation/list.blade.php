                                                                                    ...
                                                                                    <div style="">
                                                                                        ...
                                                                                        <div class="blog-content wf-td" style="word-break:break-all">
                                                                                            <div class="post-title" style="color:#373A41;line-height:16px; vertical-align: top; ">
                                                                                                <a data-title="true" style="color:#373A41;font-size:16px;line-height:16px" href="list_details?id={{$val->advice_id}}" class="bitImageAhover" title="{{$val->advice_title}}">{{$val->advice_title}}</a>
                                                                                            </div>
                                                                                            <div class="post-comment" style="color:#686868;font-size:12px;line-height:12px;">
                                                                                                <span> <span class="post_date">{{$val->advice_desc}}<span data-date="" class="post_date_text"></span></span> </span>
                                                                                            </div>
                                                                                            ...
                                                                                            <input type="hidden" class="id" value="{{$val->advice_id}}" />
                                                                                            <a style="color:gray;font-size:12px;font-family:;float:right;margin-top:23px;" href="list_details?id={{$val->advice_id}}" class="" title="{{$val->advice_title}}">详情</a>
                                                                                        </div>
                                                                                    </div> </li> @endforeach
                                                                        </ul>
                                                                    </div>
