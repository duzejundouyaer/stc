...
@section('content')
    ...
    <form action="order"  method="post" onsubmit="return check()" >
        ...
        <table class="table">
            ...
            <tr>
                <td>故障描述：</td>
                <td>
                    <textarea name="fault_details"  cols="20" rows="3"></textarea>
                </td>
            </tr>
            <tr>
                <td><br></td>
    ...
    <script>
        ...
        function errorMsg(lang, valueType, elementID)
        {
            ...
            {
                case "user_name":
                    msgInfo = isCn ? " × 您输入的用户名有1--4位汉字组成" : " × The e-mail format is error,plz input right format .eg. abc@def.com.";
                    break;
                case "user_phone":
        ...
        $("input[name='user_phone']").blur(function(){
            ...
            var user_phone_preg = /^1[3,5,8,7]\d{9}$/;
        ...
        $("input[name='user_address']").blur(function(){
            ...
            var user_address_preg = /^[\u4e00-\u9fa5]{2,20}$/;
