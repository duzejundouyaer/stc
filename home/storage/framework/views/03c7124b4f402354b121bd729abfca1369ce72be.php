		...
		<div class="wf-wrap">
			<div class="wf-container-main">
				<div id="content" class="content" role="main">
										...
										<section data-fixheight="" class="qfy-row-1-58a2ef79bd84c237455 section     no  section-text-no-shadow section-inner-no-shadow section-normal" id="bit_quco8" style="margin-bottom:0px;border-radius:0px;color:#666666;">
											...
											<div class="container">
												...
												<div class="row wpb_row">
													<div class="qfy-column-1-58a2ef79bdc14726868 qfy-column-inner  vc_span12  text-Default small-screen-Default fullrow" data-dw="1/1" data-fixheight="">
														<div style="margin-top:0px;margin-bottom:0px;margin-left:0px;margin-right:0px;border-radius:0px;border-top:1px solid #dddddd;border-bottom:1px solid #dddddd;border-left:1px solid #dddddd;border-right:1px solid #dddddd;;position:relative;;" class="column_inner ">
															...
															<div class="column_containter" style="z-index:3;position:relative;">
																<div m-padding="0px 0px 21px 0px" p-padding="0px 0px 21px 0px" css_animation_delay="0" qfyuuid="0" class="qfy-element qfy-text qfy-text-67152 wpb_text_column wpb_content_element " style="position: relative;;;line-height:1.5em;;background-repeat: no-repeat;;margin-top:10px;padding-bottom:21px;">
																	<div class="wpb_wrapper">
																		<div style="text-align: center;">
																			<span style="font-size:25px;"><span style="font-family: 微軟正黑體;"><span style="color: rgb(0, 0, 0);"><?php echo e($val->man_name); ?></span></span></span>
																		</div>
																	</div>
																</div>
																...
																<div style="width:100%;padding:0px;margin:0px;height:100%;clear:both;position:relative;background-repeat: no-repeat;" m-padding="0px 0px 0px 0px" p-padding="0px 0px 0px 0px" css_animation_delay="0" qfyuuid="0" class="qfy-element bitImageControlDiv">
																	<a class="bitImageAhover  ">
																		...
																		<div class="bitImageParentDiv wpb_single_image wpb_content_element vc_align_left">
																			<div class="wpb_wrapper">
																				...
																				<img width="620" height="413" src="<?php echo e($val->man_img); ?>" class="front_image  attachment-full" alt="7279-1-620x-u" title="" description="" data-title="7279-1-620x-u" src-img="" style="margin-left:80px;" />
																...
																<div m-padding="8px 0px 9px 0px" p-padding="8px 0px 9px 0px" css_animation_delay="0" qfyuuid="0" class="qfy-element qfy-text qfy-text-56777 wpb_text_column wpb_content_element " style="position: relative;;;line-height:1.5em;;background-repeat: no-repeat;;padding-top:8px;padding-bottom:9px;">
																	...
																	<div class="entry-content post_excerpt	" style="margin-left:80px;color:#494e56;font-size:12px;">
																...
																<div class="post-comment" style="margin-left:80px;color:#686868;font-size:12px;line-height:12px;">
													...
													<?php endforeach; ?>
													<style>.qfy-column-1-58a2ef79bdc14726868>.column_inner:hover{}.qfy-column-1-58a2ef79bdc14726868>.column_inner:hover>.background-media{}.qfy-column-1-58a2ef79bdc14726868>.column_inner:hover>.background-overlay{}@media  only screen and (min-width: 768px){.qfy-column-1-58a2ef79bdc14726868>.column_inner{padding-left:40px;padding-right:40px;padding-top:40px;padding-bottom:40px;}.wpb_row .vc_span_class.qfy-column-1-58a2ef79bdc14726868{};}@media  only screen and (max-width: 768px){.qfy-column-1-58a2ef79bdc14726868 > .column_inner{margin:0px auto 0px !important;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;}.display_entire .wpb_row .vc_span_class.qfy-column-1-58a2ef79bdc14726868 {};}</style>
												</div>
											</div>
											<style>
					...
					<center>
						<a href="citydot"><input type="button" style="width:auto;line-height: 37px;height:40px;background: #3ec9ad none repeat scroll 0 0;border: 0 none;border-radius: 0;color: #ffffff;cursor: pointer;font-size: 15px;font-weight: normal;margin: 0;padding: 0px 10px ;text-indent: 0;text-shadow: none;transition: all 0.2s ease 0s;right: 0;top:5px;" class="btn"  value="返回列表"/></a>
					</center>
						<!-- END .page-wrapper -->
						<div class="clear"></div>
					</div>
