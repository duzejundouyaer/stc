                                                                            ...
                                                                            <div class="wpb_wrapper">
                                                                                ...
                                                                                <span class='single_two_images ' style='display:inline-block;max-width:100%;font-size:0;position:relative;'>
                                                                                    <?php foreach($image as $key=>$val): ?>
                                                                                        <?php if($key%2==1): ?>)
                                                                                        <img class="front_image  ag_image" src="http://images.xn--rhqy14ac7tcmj
.top/<?php echo e($val->images_name); ?>" alt="concrete-nordic-style" description=""   data-title="concrete-nordic-style" title="" src-img ="" style='' />
                                                                                    <?php else: ?>
                                                                                            <img class=" scenery_image   ag_image" src="http://images.xn--rhqy14ac7tcmj
.top/<?php echo e($val->images_name); ?>" alt="d4c0b4f7347d6bfbb23d251927ca9838" description=""   data-title="d4c0b4f7347d6bfbb23d251927ca9838" title="" src-img ="" style='position:absolute;left:0;top:0;opacity: 0;;-webkit-transition:opacity 200ms linear;transition:opacity 200ms linear' />
                                                                                        <?php endif; ?>
                                                                                    <?php endforeach; ?>
                                                                                    <i></i>
                                                                                </span>
