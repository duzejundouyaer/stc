									...
									<div class="twelve columns ">
										<div class="bitMainTopSider wpb_row bitSider " bitDataAction="site_widget_container" bitdatamarker="bitMainTopSider" style="">
											...
											<div class="bitMainTopSider_warp" style="position:relative;z-index:3;">
												<div style="">
													<div id="bit_breadcrumbs-2" style="margin-top:20px;margin-bottom:20px;;" class="bitMainTopSiderWidget widget_text site_tooler"><div class="breadcrumb" style="font-size:14px;"><a href='http://575e5b35c4ee7.t73.qifeiye.com/?page_id=5369&categories=2' style='' class='breadcrumb-a'>News</a><span class="breadcrumb-separator" style="font-size:14px;"> / </span><span class="breadcrumb-text" style="font-size:14px;"><?php echo e($v->advice_title); ?></span></div></div> </div>
											</div>
											<div class="clear"></div>
										</div>
									</div>
													...
													<div class="qfy-column-1-58a3bfe7a7cca70120 qfy-column-inner  vc_span12  text-Default small-screen-Default fullrow" data-dw="1/1" data-fixheight=""><div style="margin-top:0px;margin-bottom:0px;margin-left:0px;margin-right:0px;border-radius:0px;;position:relative;;" class="column_inner "><div class=" background-overlay grid-overlay-0" style="background-color:transparent;"></div><div class="column_containter" style="z-index:3;position:relative;"><style>@media  only screen and (max-width: 760px) {#vc_header_58a3bfe7a849a843 .header_title{font-size:22px!important;}}</style>
																<div id="vc_header_58a3bfe7a849a843" m-padding="0px 0px 0px 0px" p-padding="0px 0px 0px 0px" css_animation_delay="0" qfyuuid="qfy_header_yws7w" class="qfy-element minheigh1px wpb_text_column wpb_content_element " style="position: relative;;;background-repeat: no-repeat;;margin-top:0px;margin-bottom:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;">
																	<div class="wpb_wrapper">
																		<H1 class="qfy_title center mobilecenter"><div class="qfy_title_inner" style="display:inline-block;position:relative;max-width:100%;"><div class="header_title" style="font-family:华文细黑;font-size:26px;font-weight:normal;font-style:normal;color:#000;"><?php echo e($v->advice_desc); ?></div></div><span style="clear:both;"></span></H1>
																	</div>
																</div>
																...
																<div style="width:100%;padding:0px;margin:0px;height:100%;clear:both;position:relative;margin-top:0px;margin-bottom:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;background-repeat: no-repeat;" m-padding="0px 0px 0px 0px" p-padding="0px 0px 0px 0px" css_animation_delay="0" qfyuuid="qfy_single_image_mgemc" m-padding="0px 0px 0px 0px" p-padding="0px 0px 0px 0px" css_animation_delay="0" qfyuuid="qfy_single_image_mgemc" class="qfy-element bitImageControlDiv"><a class="bitImageAhover  ">
																		<div class="bitImageParentDiv wpb_single_image wpb_content_element vc_align_center">
																			<div class="wpb_wrapper"><span></span><img style='width:1024px;height:300px;' src="<?php echo e($v->advice_img); ?>" class="front_image  attachment-large" alt="<?php echo e($v->advice_img); ?>" title="" description="" data-title="<?php echo e($v->advice_img); ?>" src-img="" style=''/></div>
																		</div>
																</div> </a>
