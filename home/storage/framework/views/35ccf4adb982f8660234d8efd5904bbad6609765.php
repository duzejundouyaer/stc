<?php $__env->startSection('title', '服务咨询'); ?>
                                                                                ...
                                                                                <li data-postid="6494" class="isotope-item vc_span12 grid-cat-2" style="max-width:99.8%;margin-bottom:10px;padding-bottom:10px;border-bottom:1px solid #e5e5e5;">
                                                                                    <div style="">
                                                                                        <div class="post-thumb blog-media wf-td" style="overflow:hidden;width:200px;padding-right:10px;vertical-align:top;">
                                                                                            <a href="list_details?id=<?php echo e($val->advice_id); ?>" class="bitImageAhover" title="<?php echo e($val->advice_title); ?>"><img data-t-id="8621" style="border:1px solid #cccccc;" class="vc_box_outline  ag_image" src="http://tcsadmin.完美世界.top/backend/web/<?php echo e($val->advice_img); ?>" width="220" height="140" alt="white-and-gray-apartment-L-i3hH96" description="" data-title="white-and-gray-apartment-L-i3hH96" title="" src-img="" /><i></i></a>
                                                                                            </div>
                                                                                        <div class="blog-content wf-td" style="word-break:break-all">
                                                                                            <div class="post-title" style="color:#373A41;line-height:16px; vertical-align: top; ">
                                                                                                <a data-title="true" style="color:#373A41;font-size:16px;line-height:16px" href="list_details?id=<?php echo e($val->advice_id); ?>" class="bitImageAhover" title="<?php echo e($val->advice_title); ?>"><?php echo e($val->advice_title); ?></a>
                                                                                            </div>
                                                                                            <div class="post-comment" style="color:#686868;font-size:12px;line-height:12px;">
                                                                                                <span> <span class="post_date"><?php echo e($val->advice_desc); ?><span data-date="" class="post_date_text"></span></span> </span>
                                                                                            </div>
                                                                                            ...
                                                                                            <input type="hidden" class="id" value="<?php echo e($val->advice_id); ?>" />
                                                                                            <a style="color:gray;font-size:12px;font-family:;float:right;margin-top:23px;" href="list_details?id=<?php echo e($val->advice_id); ?>" class="" title="<?php echo e($val->advice_title); ?>">详情</a>
                                                                                        </div>
