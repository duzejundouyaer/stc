																				...
																				<?php foreach($man_info as $val): ?>
																						...
																						<div style="">
                                                                                            ...
                                                                                            <div class="holder notactive" style="margin-bottom: 30px;margin-left: 10px;">
                                                                                                <a href="details?id=<?php echo e($val->man_id); ?>" class="bitImageAhover   link_image" title="<?php echo e($val->man_name); ?>"><img class="image" src="<?php echo e($val->man_img); ?>" width="500px"  height="348px"/></a>
...
echo "</br>";
echo $br_str;
}else{ echo $val->man_address;} ?><br/>发布日期：<?php echo e(date('Y-m-d',$val->man_addtime)); ?></div>
                                                                                            </div>
																						</div>
                                                                                <?php endforeach; ?>
