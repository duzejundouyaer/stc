...
<?php $__env->startSection('title', '同城网点'); ?>
																					...
																					<li data-postid="6494" class="isotope-item vc_span12 grid-cat-2" style="max-width:99.8%;margin-bottom:10px;padding-bottom:10px;border-bottom:1px solid #e5e5e5;">
																						<div style="">
																							<div class="post-thumb blog-media wf-td" style="overflow:hidden;width:200px;padding-right:10px;vertical-align:top;">
																								<a href="details?id=<?php echo e($val->man_id); ?>" class="bitImageAhover   link_image" title="<?php echo e($val->man_name); ?>"><img data-t-id="8621" style="border:1px solid #cccccc;" class="vc_box_outline  ag_image" src="<?php echo e($val->man_img); ?>" width="220" height="140" alt="white-and-gray-apartment-L-i3hH96" description="" data-title="white-and-gray-apartment-L-i3hH96" title="" src-img="" /><i></i></a>
																							</div>
																							<div class="blog-content wf-td" style="word-break:break-all">
																								<div class="post-title" style="color:#373A41;line-height:16px; vertical-align: top; ">
																									<a data-title="true" style="color:#373A41;font-size:16px;line-height:16px" href="javascript:void(0);" class="bitImageAhover   link_title" title="<?php echo e($val->man_name); ?>"><?php echo e($val->man_name); ?></a>
																								</div>
																								...
																								<a style="color:#1e73be;font-size:12px;font-family:;" href="details?id=<?php echo e($val->man_id); ?>" class="vc_read_more" title="<?php echo e($val->man_name); ?>">查看详情</a>
																							</div>
